...
const saveUser = (userData) => {
  const newUser = {
    ...
    refBy: 100  //Didaticamente, todos serão cadastrados como 100, porque não temos, no momento, estrutura para ser dinâmicamente a inserção.
  }
...
const formAction = () => {
  ...
  form.onsubmit = (event) => {
    ...
    //FormaData() consegue ler os dados dos formulários onde tem especificado o name=""
