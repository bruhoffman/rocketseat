...
// Separar um componente em vários componentes menores, te dá a possibilidade de reutilizar esses componentes menores em outros lugares
// Isso é uma prática muito comum em desenvolvimento de software
